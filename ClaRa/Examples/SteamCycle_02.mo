...
model SteamCycle_02 "As example SteamCycle_02 with more detailed heat exchanger and pump models"
  ...
  Components.TurboMachines.Pumps.PumpVLE_L1_affinity     Pump_cond(            showExpertSummary=true,
    ...
    Delta_p_max=-NOM.Pump_cond.Delta_p*2)                                                              annotation (Placement(transformation(extent={{520,-118},{500,-138}})));
  ClaRa.Visualisation.Quadruple quadruple6
    annotation (Placement(transformation(extent={{50,-160},{110,-140}})));

  ClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_IP1(redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (Delta_p_nom=NOM.valve_IP1.Delta_p, m_flow_nom=NOM.valve_IP1.m_flow), checkValve=true)
                                                                                                                                                                                                    annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={90,-30})));
  ...
  ClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_IP3(                                                                                                                                                                                    checkValve=true, redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.QuadraticNominalPoint (
  ...
  Components.VolumesValvesFittings.Fittings.SplitVLE_L2_Y       join_LP3(
    ...
    m_flow_out_nom={NOM.Turbine_LP2.summary.outlet.m_flow,NOM.preheater_LP4.summary.inlet_tap.m_flow})
        ...
        rotation=0,
        origin={350,40})));
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_LP2(checkValve=true, redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (Delta_p_nom=NOM.valve_LP1.Delta_p, m_flow_nom=NOM.valve_LP1.m_flow))
                                                                                                                                                                                                    annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={270,-30})));
  ...
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_afterPumpLP3(redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (m_flow_nom=30, Delta_p_nom=1000))
        ...
        rotation=90,
        origin={304,-150})));
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valveControl_preheater_LP2(
    checkValve=true,
  ...
  Components.VolumesValvesFittings.Fittings.JoinVLE_L2_Y join_preheater_LP3(
    ...
    redeclare model PressureLossOut = Components.VolumesValvesFittings.Fittings.Fundamentals.Linear (m_flow_nom=420))
        ...
        rotation=0,
        origin={304,-122})));
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valveControl_preheater_LP4(
    checkValve=true,
    openingInputIsActive=true,
    redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (
        m_flow_nom=8,
        ...
        rotation=0,
        origin={450,-170})));
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_LP3(                                                                                                                                            checkValve=true, redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (Delta_p_nom=NOM.valve_LP2.Delta_p, m_flow_nom=NOM.valve_LP2.m_flow))
                                                                                                                                                                                                    annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={340,-30})));
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_LP4(redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (m_flow_nom=NOM.valve_LP3.m_flow, Delta_p_nom=NOM.valve_LP3.Delta_p), checkValve=true)
                                                                                                                                                                                                    annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={410,-30})));
  ...
  Components.Electrical.SimpleGenerator simpleGenerator(hasInertia=true) annotation (Placement(transformation(extent={{542,40},{562,60}})));
  ...
  Components.VolumesValvesFittings.Valves.ValveVLE_L1 valveControl_preheater_LP1(redeclare model PressureLoss = Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (
        CL_valve=[0,0; 1,1],
        Delta_p_nom=1000,
