...
//___________________________________________________________________________//
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow_cond_nom "Nominal condensat flow" annotation(Dialog(group="Nominal Values"));
  parameter Modelica.SIunits.MassFlowRate m_flow_heat_nom "Nominal heating steam flow" annotation(Dialog(group="Nominal Values"));
