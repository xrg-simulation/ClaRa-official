...
public
  ...
  Modelica.SIunits.ReynoldsNumber Re[n,iComClassifier.classification.N_class] "Reynolds number";
  ...
  Modelica.SIunits.ReynoldsNumber Re_return[n,iComClassifier.classification.N_class] "Reynolds number";
