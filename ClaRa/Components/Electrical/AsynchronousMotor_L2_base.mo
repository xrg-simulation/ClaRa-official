...
/////////////////Parameters/////////////////////////////////////
  ...
  inner parameter Units.Frequency f_term_nom = 50 "Nominal excitation frequency" annotation(Dialog(group="Electrics Definitions"));
  parameter Units.ElectricCurrent I_rotor_nom "Rotor nominal current" annotation(Dialog(group="Electrics Definitions"));
  inner parameter Units.Voltage U_term_nom "Nominal excitation voltage"  annotation(Dialog(group="Electrics Definitions"));
...
protected
  ...
  ClaRa.Components.Utilities.Blocks.ParameterizableTable1D table(table=charLine_tau_s_, columns={2}, smoothness=smoothness);
...
/////////////////////////////////////////////////////////
  ...
  ClaRa.Basics.Units.ElectricCurrent f "Excitation frequency";
  ...
  Summary summary(showExpertSummary=showExpertSummary,
                   ...
                   U_term=U,
                   I_rotor=U_rotor0/sqrt(R_rotor^2/slip^2 + 2*pi*f*L_rotor))  annotation (Placement(transformation(
...
///////////////Electric Characteristics /////////////
  ...
  tau_bd = 3*U_rotor0^2/(8*pi^2*rpm_sync/60*f*L_rotor);
  slip_bd = R_rotor/L_rotor/2/pi/f;
  if useCharLine then
