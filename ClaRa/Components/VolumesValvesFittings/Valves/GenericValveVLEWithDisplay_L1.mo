...
model GenericValveVLEWithDisplay_L1 "Same as ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 but with dynamic opening display and opening output"
...
end GenericValveVLEWithDisplay_L1;
