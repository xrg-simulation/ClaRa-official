...
extends ClaRa.Basics.Icons.PackageIcons.ExecutableExampleb60;
  ...
  ClaRa.Components.BoundaryConditions.BoundaryVLE_hxim_flow massFlowSource_XRG3(
    m_flow_const=43.551,
    variable_m_flow=true,
    h_const=1800e3) annotation (Placement(transformation(extent={{-120,-40},{-100,-20}})));
  ...
  ClaRa.Components.BoundaryConditions.BoundaryVLE_hxim_flow massFlowSource_XRG6(
    m_flow_const=43.551,
    variable_m_flow=true,
    h_const=1800e3) annotation (Placement(transformation(extent={{-120,-100},{-100,-80}})));
  ...
  Visualisation.Quadruple quadruple2
    annotation (Placement(transformation(extent={{-84,-60},{-124,-50}})));
equation
