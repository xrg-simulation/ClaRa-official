...
//__________________________________________________________________________//
  ...
  replaceable model Material = TILMedia.SolidTypes.Steel16Mo3 constrainedby TILMedia.SolidTypes.BaseSolid  "FTW material" annotation (choicesAllMatching, Dialog(group="Fundamental Definitions"));
