...
type Init = enumeration(
    ...
    steadyDensityPressure "Steady density/mass and pressure") "The initialisation of a thermal control volume"   annotation (Documentation(info="<html>
...
<p>For revisions please consult the html-documentation shipped with ClaRa.</p>
   ...
   Icon(graphics={Line(points={{-100,100},{100,-100}}, color={255,0,0}), Line(points={{100,100},{-100,-100}}, color={255,0,0})}));
