...
record IComVLE_L3
  ...
  SI.MassFraction xi_in[N_inlet,mediumModel.nc - 1] "|Inlet||Inlet medium composition" annotation(Dialog(tab="Inlet"));
  SI.MassFraction xi_out[N_outlet,mediumModel.nc - 1] "|Outlet||Outlet medium composition" annotation(Dialog(tab="Outlet"));
end IComVLE_L3;
