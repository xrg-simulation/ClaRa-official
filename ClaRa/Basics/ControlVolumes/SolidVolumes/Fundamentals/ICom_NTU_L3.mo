...
record ICom_NTU_L3
  ...
  TILMedia.VLEFluidObjectFunctions.VLEFluidPointer ptr_i_in[3] annotation(Dialog);
  TILMedia.VLEFluidObjectFunctions.VLEFluidPointer ptr_o_in[3] annotation(Dialog);

   ClaRa.Basics.Units.EnthalpyMassSpecific h_i_out[3];
   ClaRa.Basics.Units.EnthalpyMassSpecific h_o_out[3];
  TILMedia.VLEFluidObjectFunctions.VLEFluidPointer ptr_i_out[3] annotation(Dialog);
  TILMedia.VLEFluidObjectFunctions.VLEFluidPointer ptr_o_out[3] annotation(Dialog);
