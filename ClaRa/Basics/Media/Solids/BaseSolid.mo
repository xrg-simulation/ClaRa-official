...
partial model BaseSolid
  ...
  constant ClaRa.Basics.Units.ElasticityModule E_nominal
    "Elasticity module of steel at standard reference point";
  constant ClaRa.Basics.Units.HeatExpansionRateLinear beta_nominal
    "Linear heat expansion coefficient at standard reference point";
  constant SI.ShearModulus G_nominal
    "Shear modulus at standard reference point";
