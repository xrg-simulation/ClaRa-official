...
public
  ...
  Fundamentals.SteamSignal_red_a tap_in2(m_flow=m_flow_tap2, p=p_FWT) annotation (Placement(transformation(
        extent={{-10,20},{10,30}},
        rotation=0,
  ...
  Fundamentals.SteamSignal_blue_a tap_in1(p=p_FWT) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={0,0}), iconTransformation(
        extent={{30,20},{50,30}},
