...
// _________GENERAL VALUES ___________
  ...
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_bub_bundle = TILMedia.VLEFluidFunctions.bubbleSpecificEnthalpy_pxi(
      vleMedium,
      p_vle_bundle_out) "Rprt: Bubble enthalpy at vle outlet";
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_dew_bundle = TILMedia.VLEFluidFunctions.dewSpecificEnthalpy_pxi(
      vleMedium,
      p_vle_bundle_out) "Rprt: Dew enthalpy at vle outlet";
  ...
  final parameter ClaRa.Basics.Units.TemperatureDifference Delta_T_U_bundle = ClaRa.Basics.Functions.maxAbs(T_fg_in - T_vle_bundle_out, T_fg_out - T_vle_bundle_in, 0.1) "Rprt: Upper temperatre difference of tube bundle";
  final parameter ClaRa.Basics.Units.TemperatureDifference Delta_T_L_bundle = ClaRa.Basics.Functions.minAbs(T_fg_in - T_vle_bundle_out, T_fg_out - T_vle_bundle_in, 0.1) "Rprt: Lower temperature difference of tube bundle";
...
// _________DRUM AND EVAP states ______
  ...
  final parameter ClaRa.Basics.Units.Pressure Delta_p_geo_down = TILMedia.VLEFluidFunctions.density_phxi(vleMedium, p_vle_bundle_in, h_evap_in, xi) * Modelica.Constants.g_n * (z_drum_down - z_evap_in) "Geostatic pressure difference downcomer";
  final parameter ClaRa.Basics.Units.Pressure Delta_p_geo_rise = (TILMedia.VLEFluidFunctions.density_phxi(vleMedium, p_vle_bundle_in, h_evap_in, xi)
                                                                + TILMedia.VLEFluidFunctions.density_phxi(vleMedium, p_vle_bundle_in, h_evap_out, xi))/2 * Modelica.Constants.g_n * (z_evap_out - z_evap_in)
                                                                + TILMedia.VLEFluidFunctions.density_phxi(vleMedium, p_vle_bundle_in, h_evap_out, xi) * Modelica.Constants.g_n * (z_drum_rise - z_evap_out) "Geostatic pressure difference riser";
  ...
  final parameter ClaRa.Basics.Units.Pressure p_evap_out = p_vle_bundle_in
                                                          + Delta_p_geo_down
                                                          - (TILMedia.VLEFluidFunctions.density_phxi(vleMedium, p_vle_bundle_in, h_evap_in, xi)
                                                          + TILMedia.VLEFluidFunctions.density_phxi(vleMedium, p_vle_bundle_in, h_evap_out, xi))/2 * Modelica.Constants.g_n * (z_evap_out - z_evap_in)-Delta_p_fric/2 "Outlet pressure evaporator";
...
// _________GAS Inlet _________________
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_fg_in = (m_flow_fg*h_fg_out
                                                                    -m_flow_vle_bundle*h_vle_bundle_in
                                                                    +m_flow_vle_bundle*h_vle_bundle_out
                                                                    -m_flow_vle_wall*h_vle_wall_in
                                                                    +m_flow_vle_wall*h_vle_wall_out)/m_flow_fg "FG medium's inlet specific enthalpy flue gas";
