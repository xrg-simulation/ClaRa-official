...
model MixerGas3 "brown | brown | brown"
...
//__________________________________________________________________________//
  ...
  ClaRa.StaticCycles.Fundamentals.FlueGasSignal_brown_a inlet2(flueGas=gas,T=T_in2, p=p, m_flow=m_flow_in2) annotation (Placement(transformation(
        extent={{-4,-10},{4,10}},
        rotation=90,
        origin={-10,-24})));
