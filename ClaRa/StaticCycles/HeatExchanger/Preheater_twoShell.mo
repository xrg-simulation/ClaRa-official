...
//___________________________________________________________________________//
  ...
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_tap1_out = TILMedia.VLEFluidFunctions.bubbleSpecificEnthalpy_pxi(medium, p_tap1) "Spec. enthalpy of condensed tapping 1";
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_tap2_out = TILMedia.VLEFluidFunctions.bubbleSpecificEnthalpy_pxi(medium, p_tap2) "Spec. enthalpy of condensed tapping 2";
  ...
  Fundamentals.SteamSignal_red_a tap_1_in(p=p_tap1, m_flow=m_flow_tap1) annotation (Placement(transformation(
  ...
  Fundamentals.SteamSignal_blue_b tap_1_out(
    ...
    h=h_tap1_out) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={0,0})));
  Fundamentals.SteamSignal_red_a tap_2_in(p=p_tap2, m_flow=m_flow_tap2) annotation (Placement(transformation(
        extent={{30,100},{50,110}},
        rotation=0,
        origin={0,0}), iconTransformation(
        extent={{30,100},{50,110}},
        rotation=0,
        origin={0,0})));
  Fundamentals.SteamSignal_green_a tap_2_out(
    p=p_tap2,
    m_flow=m_flow_tap2,
