within ClaRa_Obsolete.Basics.Media;
...
extends ClaRa.Basics.Icons.PackageIcons.ExecutableExampleb80;
  ...
  TILMedia.VLEFluid.MixtureCompatible.VLEFluid_ph refrigerant(
    ...
    p=1e5,
    h=1e6,
    computeTransportProperties=true) annotation (Placement(transformation(extent={{-30,20},{-10,40}})));

  TILMedia.VLEFluid.MixtureCompatible.VLEFluid_ph refrigerant2(
    redeclare TILMedia.VLEFluid.Types.BaseVLEFluid vleFluidType(
      fixedMixingRatio=false,
      nc_propertyCalculation=1,
      mixingRatio_propertyCalculation={1},
    ...
    p=1e5,
    h=1e6,
    computeTransportProperties=true) annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
