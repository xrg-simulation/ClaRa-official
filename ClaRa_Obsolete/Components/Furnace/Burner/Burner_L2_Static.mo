...
extends BaseClasses.CombustionChamberBase(                         redeclare replaceable model Geometry = ClaRa.Basics.ControlVolumes.Fundamentals.Geometry.HollowBlock);      //(flueGasCombustion(p = outlet.flueGas.p, xi = xi_flueGas));
