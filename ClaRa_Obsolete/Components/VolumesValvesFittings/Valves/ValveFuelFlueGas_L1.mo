...
//___________________________________________________________________________//
  ...
  Basics.Interfaces.FuelFlueGas_inlet inlet(flueGas(Medium=medium), final fuelType=fuelType) "Inlet port" annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
...
protected
  inner ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.ICom iCom(
    ...
    rho_in=(if useHomotopy then homotopy(ClaRa.Basics.Functions.Stepsmoother(
        1e-5,
        -1e-5,
        inlet.flueGas.m_flow)*gasIn.d + ClaRa.Basics.Functions.Stepsmoother(
        -1e-5,
        1e-5,
        inlet.flueGas.m_flow)*gasOut.d, gasIn.d) else ClaRa.Basics.Functions.Stepsmoother(
        1e-5,
        -1e-5,
        inlet.flueGas.m_flow)*gasIn.d + ClaRa.Basics.Functions.Stepsmoother(
        -1e-5,
