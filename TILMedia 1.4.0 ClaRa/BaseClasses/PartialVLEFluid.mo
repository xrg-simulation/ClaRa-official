...
partial model PartialVLEFluid "Compressible fluid model for object and member function based evaluation"
  ...
  replaceable function d_phxi =
      TILMedia.VLEFluidObjectFunctions.density_phxi (vleFluidPointer=
          vleFluidPointer);
  ...
  replaceable function h_vap_dew_Txi =
      TILMedia.VLEFluidObjectFunctions.dewSpecificEnthalpy_Txi (vleFluidPointer=
         vleFluidPointer);
