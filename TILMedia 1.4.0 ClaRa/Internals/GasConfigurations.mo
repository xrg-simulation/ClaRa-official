...
extends TILMedia.Internals.ClassTypes.ModelPackage;
  ...
  extends TILMedia.Internals.ClassTypes.ModelPackage;
    ...
    equation
      ...
      if (gasType.condensingIndex <= 0) then
        // some properties are only pressure dependent if there is vapour in the mixture
        T = GasObjectFunctions.PureComponentDerivatives.temperature_phxi(
          1,
          h,
          xi,
          gasPointer);
      ...
      d = GasObjectFunctions.density_phxi(
        p,
        h,
        xi,
        gasPointer);
      cp =
        GasObjectFunctions.PureComponentDerivatives.specificIsobaricHeatCapacity_phxi(
        p,
        h,
        xi,
        gasPointer);
      drhodh_pxi =
        GasObjectFunctions.PureComponentDerivatives.densityDerivativeWRTspecificEnthalpy_phxi(
        p,
        h,
        xi,
        gasPointer);
      drhodp_hxi =
        GasObjectFunctions.PureComponentDerivatives.densityDerivativeWRTpressure_phxi(
        p,
        h,
        xi,
        gasPointer);
      ...
      if computeTransportProperties then
        transp = TILMedia.Internals.GasObjectFunctions.transportProperties_pTxi(
          p,
          T,
          xi,
          gasPointer);
    ...
    equation
      ...
      d = GasObjectFunctions.density_pTxi(
        p,
        T,
        xi,
        gasPointer);
