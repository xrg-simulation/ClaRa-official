...
model Liquid_ph
  ...
  extends TILMedia.BaseClasses.PartialLiquid_ph(          liquidPointer=TILMedia.Internals.TILMediaExternalObject(
        "Liquid",
...
equation
  (d,cp,beta) =
    TILMedia.Internals.LiquidObjectFunctions.properties_hxi(
    h,
    xi,
    liquidPointer);
  T =
