...
model Gas "Gas vapor model for object and member function based evaluation"
  ...
  redeclare replaceable function d_phxi =
      TILMedia.Internals.GasObjectFunctions.density_phxi,
  redeclare replaceable function s_phxi =
      TILMedia.Internals.GasObjectFunctions.specificEntropy_phxi,
  redeclare replaceable function T_phxi =
      TILMedia.Internals.GasObjectFunctions.temperature_phxi,
  ...
  redeclare replaceable function w_phxi =
      TILMedia.Internals.GasObjectFunctions.speedOfSound_phxi,
  ...
  redeclare replaceable function phi_phxi =
      TILMedia.Internals.GasObjectFunctions.relativeHumidity_phxi,
  ...
  redeclare replaceable function h_psxi =
      TILMedia.Internals.GasObjectFunctions.specificEnthalpy_psxi,
  redeclare replaceable function T_psxi =
      TILMedia.Internals.GasObjectFunctions.temperature_psxi,
  ...
  redeclare replaceable function d_pTxi =
      TILMedia.Internals.GasObjectFunctions.density_pTxi,
  redeclare replaceable function h_pTxi =
      TILMedia.Internals.GasObjectFunctions.specificEnthalpy_pTxi,
  redeclare replaceable function s_pTxi =
      TILMedia.Internals.GasObjectFunctions.specificEntropy_pTxi,
  ...
  redeclare replaceable function kappa_pTxi =
      TILMedia.Internals.GasObjectFunctions.isothermalCompressibility_pTxi,
  redeclare replaceable function w_pTxi =
      TILMedia.Internals.GasObjectFunctions.speedOfSound_pTxi,
  ...
  redeclare replaceable function p_i_pTxin =
      TILMedia.Internals.GasObjectFunctions.partialPressure_pTxin,
  redeclare replaceable function xi_gas_pTxi =
      TILMedia.Internals.GasObjectFunctions.gaseousMassFraction_pTxi,
  redeclare replaceable function phi_pTxi =
      TILMedia.Internals.GasObjectFunctions.relativeHumidity_pTxi,
  ...
  redeclare replaceable function Pr_pTxi =
      TILMedia.Internals.GasObjectFunctions.prandtlNumber_pTxi,
  ...
  redeclare replaceable function eta_pTxi =
      TILMedia.Internals.GasObjectFunctions.dynamicViscosity_pTxi,
  ...
  redeclare replaceable function humRatio_xi =
      TILMedia.Internals.GasObjectFunctions.humidityRatio_xi,
  ...
  redeclare replaceable function T_freeze =
    ...
    redeclare replaceable function xi_s_pTxidg =
        TILMedia.Internals.GasObjectFunctions.saturationMassFraction_pTxidg (gasPointer=gasPointer));
