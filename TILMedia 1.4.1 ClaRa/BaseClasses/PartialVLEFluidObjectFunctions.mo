...
package PartialVLEFluidObjectFunctions
  ...
  replaceable partial function specificEnthalpy_dTxi
    extends PartialVLEFluidObjectFunction;
    input SI.Density d "Density";
    input SI.Temperature T "Temperature";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
    replaceable input TILMedia.Internals.BasePointer vleFluidPointer constrainedby
  ...
  replaceable partial function liquidTemperature_dTxi
    extends PartialVLEFluidObjectFunction;
    input SI.Density d "Density";
    input SI.Temperature T "Temperature";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
  ...
  replaceable partial function vapourTemperature_dTxi
    extends PartialVLEFluidObjectFunction;
    input SI.Density d "Density";
    input SI.Temperature T "Temperature";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
  ...
  replaceable partial function dewSpeedOfSound_Txi
    extends PartialVLEFluidObjectFunction;
    input SI.Temperature T "Temperature";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
    replaceable input TILMedia.Internals.BasePointer vleFluidPointer constrainedby
  ...
  replaceable partial function bubbleSpeedOfSound_Txi
    extends PartialVLEFluidObjectFunction;
    input SI.Temperature T "Temperature";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
    replaceable input TILMedia.Internals.BasePointer vleFluidPointer constrainedby
  ...
  replaceable partial function dewSpeedOfSound_pxi
    extends PartialVLEFluidObjectFunction;
    input SI.AbsolutePressure p "Pressure";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
    replaceable input TILMedia.Internals.BasePointer vleFluidPointer constrainedby
  ...
  replaceable partial function bubbleSpeedOfSound_pxi
    extends PartialVLEFluidObjectFunction;
    input SI.AbsolutePressure p "Pressure";
    input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
    replaceable input TILMedia.Internals.BasePointer vleFluidPointer constrainedby
